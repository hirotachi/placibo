...
(function( $ ) {
    ...
    $.redux.checkRequired = function() {
        ...
        $( "body" ).on(
            'change',
            //NM: '.redux-main select, .redux-main radio, .redux-main input[type=checkbox], .redux-main input[type=hidden]',
            '.redux-main select, .redux-main radio, .redux-main input[type=checkbox], .redux-main input[type=hidden], .redux-main input[type=radio]',
            function( e ) {
