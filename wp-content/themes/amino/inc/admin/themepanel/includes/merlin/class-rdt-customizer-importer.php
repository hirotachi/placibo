...
class Rdt_Customizer_Importer {
	...
	public static function import( $customizer_import_file_path ) {
		...
		Rdt_Logger::get_instance()->info( __( 'The customizer import has finished successfully', '@@textdomain' ) );
		return true;
	}
	...
	public static function import_customizer_options( $import_file_path ) {
		...
		// Import images.
		if ( apply_filters( 'rdt_customizer_import_images', true ) ) {
		...
		if ( isset( $data['options'] ) ) {
			...
			foreach ( $data['options'] as $option_key => $option_value ) {
				$option = new Rdt_Customizer_Option( $wp_customize, $option_key, array(
					'default'    => '',
					'type'       => 'option',
		...
		$use_wp_customize_save_hooks = apply_filters( 'rdt_enable_wp_customize_save_hooks', false );
