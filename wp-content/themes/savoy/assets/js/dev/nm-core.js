	...
	NmTheme.prototype = {
        ...
        elementBanner: function($banners) {
            ...
            if (self.isShop && self.filtersEnableAjax) {
                $banners.find('.nm-banner-shop-link').bind('click.nmBannerAjax', function(e) {
                    e.preventDefault();
        ...
        elementElementorTabs: function($tabs) {
            ...
            $tabs.children('.nm-elementor-tabs-wrapper').children('.nm-elementor-tab').bind('click', function(e) {
                e.preventDefault();
