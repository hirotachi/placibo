...
b(this).children(".sub-menu");e.length&&e.css("left","")});if(!a.isShop)a.$header.on("click.nmHeaderShopRedirect",".shop-redirect-link",function(e){e.preventDefault();e=b(this).children("a").attr("href");window.location.href=e+"#shop"});a.$mobileMenuBtn.bind("click",function(e){e.preventDefault();a.$body.hasClass(a.classMobileMenuOpen)?a.mobileMenuClose(!0):a.mobileMenuOpen()});a.$mobileMenuLi.bind("click.nmMenuToggle",function(e){e.stopPropagation();var g=b(this),l=g.children("ul");!l.length||g.hasClass("nm-notoggle")&&
