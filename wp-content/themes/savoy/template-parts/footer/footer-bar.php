        ...
        <div class="nm-row">
            <div class="nm-footer-bar-left col-md-8 col-xs-12">
                <?php 
                    ...
                    $logo_title_attr_escaped = ( strlen( $nm_theme_options['footer_bar_logo']['title'] ) > 0 ) ? 'title="' . esc_attr( $nm_theme_options['footer_bar_logo']['title'] ) . '"' : '';
                ?>
                <div class="nm-footer-bar-logo">
                    <img src="<?php echo esc_url( $logo_src ); ?>"<?php echo $logo_title_attr_escaped; ?> />
                </div>
                <?php endif; ?>
